...
class Ehwgesture(torch.utils.data.Dataset):
    """
    EHWGesture RGB frame-sequence loader based on clip manifests.
    ...
    def __init__(self, cfg, mode, num_retries=10):
        ...
        logger.info("Constructing EHWGesture {}...".format(mode))
    ...
    def _construct_loader(self):
        ...
        logger.info(
            "EHWGesture dataloader constructed (size: {}) from {}".format(
